package org.apache.spark.metrics.systemPerformance;
...
public class MonitorServiceImpl implements IMonitorService {
    ...
    private java.lang.management.ManagementFactory ManagementFactory;
...
//%Cpu(s):0.9 us,  0.2 sy,  0.0 ni, 98.8 id,  0.1 wa,  0.0 hi,  0.0 si,  0.0 st
            ...
            System.out.println(brStat.readLine());
            String usageline = brStat.readLine();
            System.out.println(usageline);
            String rate = usageline.split(":")[1];
            System.out.println(rate);
            String used = rate.split(",")[0].trim().split(" ")[0];
            Float cpuUsage = new Float(used);
